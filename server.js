...
app.use(function (req, res, next) {
    res.header("Access-Control-Allow-Origin", "https://drive.google.com","https://family-tree-yiq8.onrender.com"); // update to match the domain you will make the request from
